...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            <form method="post" action="{{ route('employer.job.update',$job->id) }}">
                @csrf
                @method('put')
                <div class="col-lg-12">
                                                    ...
                                                    <select name="jobtype_id" class="job-type-option-field select2-hidden-accessible">
                                                        @foreach($jobtypes as $jobtype)
                                                            <option value="{{ $jobtype->id }}"
                                                                {{ $job->jobtype->id == $jobtype->id ? 'selected':'' }}>
                                                                {{ $jobtype->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <select name="career_id" class="job-category-option-field select2-hidden-accessible">
                                                        @foreach($careers as $career)
                                                            ...
                                                            {{ $job->career->id == $career->id ? 'selected':'' }}>
                                                                {{ $career->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div><!-- end form-group -->
                                                ...
                                                <div class="form-group">
                                                    <select name="category_id" class="category-option-field select2-hidden-accessible">
                                                        @foreach($categories as $category)
                                                            ...
                                                            {{ $job->category->id == $category->id ? 'selected':'' }}>
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="budget" class="form-control" type="number"
                                                           placeholder="Type Your Projrct Budget" value="{{ $job->budget }}">
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 column-lg-full">
                                            <div class="input-box">
                                                ...
                                                <input name="experience" class="form-control" type="text"
                                                       placeholder="Enter Your Experience" value="{{ $job->experience }}">
                                            </div>
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 column-lg-full">
                                            <div class="input-box">
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="vacancy"
                                                           placeholder="01, 02, 03" value="{{ $job->vacancy }}">
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 column-lg-full">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="date-range form-control" type="date" name="deadline" value="{{ $job->deadline }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <textarea class="message-control form-control" name="description"
                                                              placeholder="Write your job description">{{ $job->description }}</textarea>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-12 -->
                                    </div><!-- end row -->
