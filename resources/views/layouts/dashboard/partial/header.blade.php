            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="menu-full-width">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('public/images/logo2.png') }}" alt="logo"></a>
                        </div><!-- end logo -->
                                    ...
                                    <div class="notification-item">
                                        <div class="dropdown">
                                            <button class="notification-btn dot-status online-status dropdown-toggle" type="button" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <img src="{{ URL::to(Auth::user()->image) }}" alt="John-doe">
                                            </button>
                                                ...
                                                <div class="mess-dropdown">
                                                    ...
                                                    <div class="mess__body">
                                                        <ul class="list-items">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{ route('employer.setting') }}" class="d-block">
